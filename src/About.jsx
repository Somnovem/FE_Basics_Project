    ...
    <main className="about-container">
      ...
      <section className="profiles">
        ...
        <div className="profile-card">
          ...
          <p>
            Моє улюблене місто — Вінниця. Вона подібна до Києва, але менша за розміром, більш спокійна, 
            із своєрідною архітектурою та атмосферою, тому теж гарна і затишна.
          </p>
